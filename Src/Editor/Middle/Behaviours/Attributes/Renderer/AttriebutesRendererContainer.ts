...
@DefineAttributesRenderer(RendererContainer)
export class AttriebutesRendererContainer extends AttributesBase {
	namearea;
	render(transform: Transform, render: RendererContainer) {
