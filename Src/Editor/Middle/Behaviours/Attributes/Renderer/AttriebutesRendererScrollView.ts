...
@DefineAttributesRenderer(RendererScrollView)
export class AttriebutesRendererScrollView extends AttributesBase {
	namearea;
	render(transform: Transform, render: RendererScrollView) {
